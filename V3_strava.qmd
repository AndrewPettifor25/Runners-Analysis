...
fita <- lm(VO2_Max ~ Avg.Pace ,strava_df_r)
fitb <- lm(VO2_Max ~ Avg.Pace + Distance,strava_df_r)
fitc <- lm(VO2_Max ~ Avg.Pace + Distance + Avg.HR ,strava_df_r)
fitd <- lm(VO2_Max ~ Avg.Pace + Distance + Avg.HR + Aerobic.TE ,strava_df_r)
fite <- lm(VO2_Max ~ Avg.Pace + Distance + Avg.HR + Aerobic.TE + Stride_Efficiency ,strava_df_r)
